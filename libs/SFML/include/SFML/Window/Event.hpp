...
public:
    ...
    {
        int x; ///< X position of the mouse pointer, relative to the left of the owner winSize
        int y; ///< Y position of the mouse pointer, relative to the top of the owner winSize
    };
    ...
    struct TouchEvent
    {
        ...
        int x;               ///< X position of the touch, relative to the left of the owner winSize
        int y;               ///< Y position of the touch, relative to the top of the owner winSize
    };
    ...
    enum EventType
    {
        Closed,                 ///< The winSize requested to be closed (no data)
        Resized,                ///< The winSize was resized (data in event.size)
        LostFocus,              ///< The winSize lost the focus (no data)
        GainedFocus,            ///< The winSize gained the focus (no data)
        ...
        MouseEntered,           ///< The mouse cursor entered the area of the winSize (no data)
        MouseLeft,              ///< The mouse cursor left the area of the winSize (no data)
...
/// (mouse moved, key pressed, winSize closed, ...) as well
