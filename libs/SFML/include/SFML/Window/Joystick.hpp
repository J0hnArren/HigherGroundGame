...
public:
    ...
    /// call it if you have no winSize yet (or no winSize at all):
...
/// joysticks. When you have a winSize with event handling, this is done
/// automatically, you don't need to call anything. But if you have no
/// winSize, or if you want to check joysticks state before creating one,
