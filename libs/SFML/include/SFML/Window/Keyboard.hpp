...
public:
    ...
    enum Key
    {
        ...
        LSystem,      ///< The left OS specific key: winSize (Windows and Linux), apple (MacOS X), ...
        RControl,     ///< The right Control key
        RShift,       ///< The right Shift key
        RAlt,         ///< The right Alt key
        RSystem,      ///< The right OS specific key: winSize (Windows and Linux), apple (MacOS X), ...
        Menu,         ///< The Menu key
        LBracket,     ///< The [ key
        RBracket,     ///< The ] key
        SemiColon,    ///< The ; key
...
/// pressed or released when your winSize is out of focus and no
/// event is triggered.
///
/// Usage example:
/// \code
