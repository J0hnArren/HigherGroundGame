...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the current position of the mouse in winSize coordinates
    ///
    /// This function returns the current position of the mouse
    /// cursor, relative to the given winSize.
    ///
    /// \param relativeTo Reference winSize
    ///
    /// \return Current position of the mouse
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Set the current position of the mouse in winSize coordinates
    ///
...
/// time and directly, without having to deal with a winSize and
...
/// moved, pressed or released when your winSize is out of focus
...
/// to the desktop) and one that operates in winSize coordinates
/// (relative to a specific winSize).
///
/// Usage example:
/// \code
...
///
/// // set mouse position relative to a winSize
/// sf::Mouse::setPosition(sf::Vector2i(100, 200), winSize);
/// \endcode
///
