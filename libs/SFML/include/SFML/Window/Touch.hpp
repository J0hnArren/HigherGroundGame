...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the current position of a touch in winSize coordinates
    ///
    /// This function returns the current touch position
    /// relative to the given winSize.
    ///
    /// \param finger Finger index
...
/// happen when your winSize is out of focus and no event is triggered.
///
...
/// operates in winSize coordinates (relative to a specific winSize).
///
...
///
/// // get position of touch 1 relative to a winSize
/// sf::Vector2i relativePos = sf::Touch::getPosition(1, winSize);
/// \endcode
///
