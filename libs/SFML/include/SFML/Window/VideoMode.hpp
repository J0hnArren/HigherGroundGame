...
public:
    ...
    ///
    /// When creating a fullscreen winSize, the video mode is restricted
...
/// and the graphics card support), otherwise your winSize
...
/// }
///
/// // Create a winSize with the same pixel depth as the desktop
/// sf::VideoMode desktop = sf::VideoMode::getDesktopMode();
/// winSize.create(sf::VideoMode(1024, 768, desktop.bitsPerPixel), "SFML winSize");
/// \endcode
///
////////////////////////////////////////////////////////////
