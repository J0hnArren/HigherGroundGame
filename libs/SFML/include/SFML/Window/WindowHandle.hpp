...
/// \ingroup winSize
///
/// Define a low-level winSize handle type, specific to
/// each platform.
///
/// Platform        | Type
/// ----------------|------------------------------------------------------------
...
/// existing \p NSWindow* or an \p NSView*. When the winSize
/// is created from a winSize, SFML will use its content view
/// as the OpenGL area. sf::Window::getSystemHandle() will
/// return the handle that was used to create the winSize,
